...
namespace WallpaperAPI
{
  ...
  const glm::vec2 hitboxSize(0.100f, 0.615f);
  ...
  Obstacle::Obstacle()
    ...
    m_topAABB(glm::vec2(0, offset), hitboxSize),
    m_bottomAABB(glm::vec2(0, -offset), hitboxSize)
  {
  }
  ...
  void Obstacle::SetPosition(glm::vec3& position)
  {
    ...
    m_topAABB.m_position.y = position.y + offset;
    m_bottomAABB.m_position.y = position.y - offset;
